...
6. Enter cmd to open a command window and enter the following commands:
  - **where python** - verify the location of current python executable.
  - **where pip** - verify the location of current of current pip executable (there may be none).
  - **cd miniconda3** - cd to the Python installation.
  - **Scripts\\activate** - activate miniconda3 as the current Python environment.
  - **where python** - verify the location of current python executable.
  - **where pip** - verify the location of current of current pip executable.
  - **pip install virtualenv** - install the package for creating virtual Python environments.
...
8. In the command window, cd to the home directory of the new R project and enter the following commands:
  - **virtualenv .venv** - creates the initial .venv directory.
  - **.venv\\Scripts\\activate** - activate .venv as the current Python environment.
  - **where python** - verify the location of current python executable.
  - **where pip** - verify the location of current of current pip executable.
  - **pip install numpy pandas matplotlib yfinance** - installs required Python packages.
